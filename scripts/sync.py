...
class MySQLDBConsolidator:
    ...
    def __init__(self, source_databases: List[Dict], target_config: Dict, log_file: str = "../log/consolidation_failures.json"):
        self.source_databases = source_databases
        self.target_config = target_config
        self.log_file = log_file
        self.snapshot_file = "../log/consolidation_snapshot.json"
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('../log/db_consolidation.log'),
